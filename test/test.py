...
def seperateLanes(lanes_list):
    lanes_order = [lanes_list[0][0], lanes_list[1][0], lanes_list[2][0], lanes_list[3][0], lanes_list[4][0]]
    lanes_order.sort()
    left_lane1 = getLane(lanes_list, lanes_order.pop(0))
    left_lane2 = getLane(lanes_list, lanes_order.pop(0))
    lanes_order.pop(0) # discard
...
for index, line in enumerate(lines):
    x1,y1,x2,y2=line[0]
    cv2.line(crop_image,(x1,y1),(x2,y2),(0,255,0),2)
    cv2.line(img,(mid_x-65+x1,y1),(mid_x-65+x2,y2),(0,255,0),2)
...
dy2 = abs(right_lane2[3]-right_lane2[1])
dx2 = abs(right_lane2[2]-right_lane2[0])
top1 = extendLine(right_lane1, dy1, dx1, 0)
bottom1 = extendLine(right_lane1, dy1, dx1, height, up=False)
cv2.line(img, bottom1, top1, (255, 255, 0), 2)
top2 = extendLine(right_lane2, dy2,  dx2, 0)
bottom2 = extendLine(right_lane2, dy2, dx2, height, up=False)
cv2.line(img, bottom2, top2, (255, 255, 0), 2)
